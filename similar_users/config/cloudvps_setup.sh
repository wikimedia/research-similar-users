...
# While private, the necessary files are manually scp-ed onto the instance. Ideally this starts with a git clone command.
...
# these files have been scp-ed to the instance in advance
mv temporal.tsv ${ETC_PATH}/resources
mv coedit_counts.tsv ${ETC_PATH}/resources
mv metadata.tsv ${ETC_PATH}/resources
